...
def cli_main():
    ...
    #parser.add_argument('--text', type=str, default='人喜盛世鼠兆丰年', help='input text')
    #args = options.parse_args_and_arch(parser)
    args = myargs()
    
    args.path = './fairseq/checkpoints/couplet/checkpoint27.pt'
    args.beam = 4
    args.lenpen = 0.6
    ...
    for line in sys.stdin:
        _, out=infer_onebyone(args,models,task,input=line)
...
def create_model():
    ...
    args.path = os.path.join(rootpath,'fairseq/checkpoints/couplet/checkpoint27.pt')
    args.beam = 4
    args.lenpen = 0.6
    args.no_progress_bar = True
    args.log_format = 'json'
