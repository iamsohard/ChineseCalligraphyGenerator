...
this.id_=this.player_.id()+"_youtube_api";this.el_=videojs.Component.prototype.createEl("iframe",{id:this.id_,className:"vjs-tech",scrolling:"no",marginWidth:0,marginHeight:0,frameBorder:0,webkitAllowFullScreen:"true",mozallowfullscreen:"true",allowFullScreen:"true"});this.iframeblocker=videojs.Component.prototype.createEl("div",{className:"iframeblocker"});var c=this;(this.toggleOnClick=!!this.player_.options().toggleOnClick)?this.iframeblocker.addEventListener("click",function(){c.paused()?c.play():
c.pause()}):this.iframeblocker.addEventListener("click",function(){!0===c.player_.userActive()?c.player_.userActive(!1):c.player_.userActive(!0)});this.iframeblocker.addEventListener("mousemove",function(a){c.player_.userActive()||c.player_.userActive(!0);a.stopPropagation();a.preventDefault()});this.iframeblocker.addEventListener("tap",function(){!0===c.player_.userActive()?c.player_.userActive(!1):c.player_.userActive(!0)});this.player_.options().ytcontrols||(this.iframeblocker.style.display="block");
...
this.videoId+"?"+videojs.Youtube.makeQueryString(b)):this.el_.src="https://www.youtube.com/embed/"+this.videoId+"?"+videojs.Youtube.makeQueryString(b);a.ready(function(){c.player_el_.getElementsByClassName("vjs-control-bar")[0].appendChild(c.qualityButton);c.playOnReady&&!c.player_.options().ytcontrols&&("undefined"!=typeof c.player_.loadingSpinner&&c.player_.loadingSpinner.show(),"undefined"!=typeof c.player_.bigPlayButton&&c.player_.bigPlayButton.hide())});this.player_.options().ytcontrols?this.player_.controls(!1):
this.player_.poster()||(null==this.videoId?this.iframeblocker.style.backgroundColor="black":this.player_.poster("https://img.youtube.com/vi/"+this.videoId+"/0.jpg"));videojs.Youtube.apiReady?this.loadYoutube():(videojs.Youtube.loadingQueue.push(this),videojs.Youtube.apiLoading||(a=document.createElement("script"),a.onerror=function(a){c.onError(a)},a.src=this.forceSSL||"file:"===window.location.protocol?"https://www.youtube.com/iframe_api":"//www.youtube.com/iframe_api",f=document.getElementsByTagName("script")[0],
...
videojs.Youtube.makeQueryString=function(a){var b=[],d;for(d in a)a.hasOwnProperty(d)&&b.push(encodeURIComponent(d)+"="+encodeURIComponent(a[d]));return b.join("&")};window.onYouTubeIframeAPIReady=function(){for(var a;a=videojs.Youtube.loadingQueue.shift();)a.loadYoutube();videojs.Youtube.loadingQueue=[];videojs.Youtube.apiReady=!0};
...
1920;this.player_.videoHeight=1080;break;case "small":this.player_.videoWidth=320;this.player_.videoHeight=240;break;case "tiny":this.player_.videoWidth=144;this.player_.videoHeight=108;break;default:this.player_.videoWidth=0,this.player_.videoHeight=0}this.player_.trigger("ratechange")};videojs.Youtube.prototype.onError=function(a){this.player_.error=a;this.player_.trigger("error")};function setInnerText(a,b){if(void 0===a)return!1;a["innerText"in a?"innerText":"textContent"]=b}
